...
Interview sessions: **0 / 5**.
Self-flagged-weak answers graded L3+: **0**.

## Softness — last 0 interview sessions

Not enough interview sessions to compare. Needs 2; has 0.

## .NET

90 concepts · average **L0.00** · last evidence —
...
**Gaps:** open 0 · studying 0 · taught 0 · verified 0 · regressed 0

## Review queue

0 scheduled · **0 overdue** · 0 due in the next 7 days.
...
Excursions: 0 of 0 interview sessions.
Last session: none.
